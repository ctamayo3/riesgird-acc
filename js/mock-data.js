...
const PONENTES = [
  ...
  { id: "p3", nombre: "Dra. Jeri Ramón Ruffner", cargo: "Rectora", institucion: "Universidad Nacional Mayor de San Marcos (UNMSM)", foto_url: null },
  { id: "p4", nombre: "Dr. José Barrón López", cargo: "Rector", institucion: "Universidad Nacional Agraria La Molina (UNALM)", foto_url: null },
  { id: "p5", nombre: "Dra. Mary Mollo Medina", cargo: "Secretaría Técnica de la Red RiesGIRD-ACC LAC", institucion: "Universidad ESAN", foto_url: null },
  { id: "p6", nombre: "Dra. Mayra Arauco", cargo: "Moderadora — Track A", institucion: "Universidad ESAN", foto_url: null },
  { id: "p7", nombre: "Edwin M. Pino", cargo: "Presentador — Track A", institucion: "Universidad Nacional Jorge Basadre Grohmann", foto_url: null },
  { id: "p8", nombre: "Dr. David Ricardo Asencios Templo", cargo: "Presentador — Track A", institucion: "Universidad Nacional Agraria La Molina (UNALM)", foto_url: null },
  { id: "p9", nombre: "Prof. Eden Atalaya", cargo: "Moderador — Track B", institucion: "Universidad Nacional de Ingeniería (UNI)", foto_url: null },
  { id: "p10", nombre: "Dr. Rodrigo Alexis Cea", cargo: "Moderador — Track B", institucion: "Universidad de Concepción, Chile", foto_url: null },
  ...
  { id: "p14", nombre: "Dr. Antonio Medina Calcaño", cargo: "Panelista", institucion: "Universidad Autónoma de Santo Domingo, Rep. Dominicana", foto_url: null },
  { id: "p15", nombre: "José Ventura", cargo: "Moderador", institucion: "Universidad ESAN", foto_url: null },
  { id: "p16", nombre: "Elizabeth Silvestre Espinoza", cargo: "Moderadora", institucion: "Universidad Nacional Agraria La Molina (UNALM)", foto_url: null },
  { id: "p17", nombre: "Dr. René Cornejo Díaz", cargo: "Moderador — Track D", institucion: "Universidad ESAN", foto_url: null },
  { id: "p18", nombre: "Dr. Luis Alberto Vargas Marín", cargo: "Panelista — Track D", institucion: "Universidad de Manizales, Colombia", foto_url: null },
];
